...
```bash
$ export SHELLY_EXPORTER_IMAGE=ghcr.io/easimon/shelly-exporter:3.0.0 # x-release-please-version
...
services:
  shelly-exporter:
    image: ghcr.io/easimon/shelly-exporter:3.0.0 # x-release-please-version
    environment:
      SHELLY_AUTH_USERNAME: your_username
      SHELLY_AUTH_PASSWORD: your_password
      SHELLY_DEVICES_HOSTS: shelly1.local,192.168.0.5
